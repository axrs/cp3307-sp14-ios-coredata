...
- (NSArray *)allRecords {
    ...
    NSEntityDescription *entity = [NSEntityDescription entityForName:@"CCPerson"
                                              inManagedObjectContext:self.managedObjectContext];
    [request setEntity:entity];

    NSSortDescriptor *sortDescriptor = [[NSSortDescriptor alloc] initWithKey:@"age" ascending:NO];
    NSArray *sortedAges = [[NSArray alloc] initWithObjects:sortDescriptor, nil];

    [request setSortDescriptors:sortedAges];
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CCData" withExtension:@"momd"];
